...
export default async function Squad() {
  ...
  const stats = await safeQuery(
    supabase
      ...
      .select('player_id,appearances,minutes,goals,assists,shots,shots_on_target,passes,successful_passes,successful_dribbles,duels_won,recoveries,tackles,interceptions,fouls,yellow_cards,red_cards,saves,goals_conceded')
      .eq('user_id', user.id),
    [] as any[]
  );
          ...
          <section key={group} className="role-section">
            ...
            <div className="player-grid">
              {groupPlayers.length === 0 ? (
                ...
                const photo = p.photo_url || `https://a.espncdn.com/i/headshots/soccer/players/full/${p.external_id}.png`;
