...
La base è pronta per essere pubblicata con Supabase Auth/Postgres e sincronizzazione server-side Sportmonks. Serve ancora inserire le credenziali del tuo progetto Supabase e il token Sportmonks.
...
- pagina Impostazioni
- endpoint server-side per Sportmonks
- struttura pronta per sincronizzazione

Prossimo:
- sincronizzazione completa fixtures/lineups/events/statistiche/infortuni da Sportmonks
