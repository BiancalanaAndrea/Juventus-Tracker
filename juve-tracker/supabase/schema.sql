...
--
-- ATTENZIONE: questo script CANCELLA ed eventuali tabelle precedenti
-- con questi nomi (es. quelle create dalla vecchia versione con l'API)
-- e le ricrea da zero. Se avevi già dati inseriti manualmente, andranno
-- persi: è il modo più sicuro per assicurarsi che la struttura sia
-- quella corretta, dato che "create table" da solo non aggiorna una
-- tabella già esistente con una struttura diversa.
-- ============================================================
